...
export const metadata: Metadata = {
  title: "About Us - Building Safer Rides Together",
  description: "Learn about ShareRideStories' mission to create safer ride-hailing experiences through community-driven transparency. Discover how we're building a platform for honest driver reviews and passenger safety.",
  keywords: [
    "about shareridestories",
    "ride safety mission",
    "community reviews platform",
    "passenger safety advocacy",
    "transparent ride sharing",
    "driver accountability"
  ],
  openGraph: {
    title: "About ShareRideStories - Building Safer Rides Together",
    description: "Learn about our mission to create safer ride-hailing experiences through community-driven transparency and honest driver reviews.",
